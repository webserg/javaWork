...
public class WwdEmbedded {
    public static void main(String[] args) {
        ...
        try {
            /*
             * Load the Derby driver. When the embedded
             * Driver is used this action start the Derby
             * engine. Catch an error and suggest a
             * CLASSPATH problem
             */
        ...
        try {
            // Create (if needed) and connect to the
            // database
            ...
            /***
             * In embedded mode, an application should shut
             * down Derby. Shutdown throws the XJ015
             * exception to confirm success.
             ***/
            ...
            // Beginning of the primary catch block: uses
            // errorPrint method
        } catch (Throwable e) {
            /*
             * Catch all exceptions and pass them to the
             * exception reporting method
             */
