...
class CarWorld extends JPanel {
    ...
    Image redCar;
    Image blueCar;
    String path = "C:\\devel\\webserg-common\\thread\\exercises\\goteborg\\carBridge\\";

    TrafficControllerI controller;
    ...
    public CarWorld() {
        ...
        redCar = toolkit.getImage(path + "image\\redcar.gif");
        mt.addImage(redCar, 0);
        blueCar = toolkit.getImage(path + "image\\bluecar.gif");
        mt.addImage(blueCar, 1);
        bridge = toolkit.getImage(path + "image\\bridge1.gif");
