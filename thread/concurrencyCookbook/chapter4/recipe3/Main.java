package thread.concurrencyCookbook.chapter4.recipe3;
...
/**
 * PeriodictskExecution class of the example. Creates and execute ten FactorialCalculator tasks
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.printf("PeriodictskExecution: Number of Completed Tasks: %d\n", executor.getCompletedTaskCount());
            for (int i = 0; i < resultList.size(); i++) {
                Future<Integer> result = resultList.get(i);
                System.out.printf("PeriodictskExecution: Task %d: %s\n", i, result.isDone());
            }
            try {
                Thread.sleep(50);
        ...
        // Write the results
        System.out.printf("PeriodictskExecution: Results\n");
        for (int i = 0; i < resultList.size(); i++) {
            Future<Integer> result = resultList.get(i);
            Integer number = null;
            try {
